<?php
//
/*   Basado en smtp.php de phpbb2.o
 *   begin : Wed May 09 2001,  copyright : (C) 2001 The phpBB Group, email : support@phpbb.com
...
//-----------------------------
 ...
 public $email_from;
 //---------------------------
 function mailer($smtp_host='', $smtp_username='', $smtp_password='', $email_from='') {
 ...
 function message_die($error_type, $error_message, $line, $file) {
  die("**Error: $error_type, $error_message, line $line, file $file<br />");
  return false;
 }
//-----------------------------
  function server_parse($socket, $response, $line = __LINE__) {
  	...
  	if (!(substr($server_response, 0, 3) == $response)) {
  		$this->message_die('GENERAL_ERROR', "Ran into problems sending Mail. Response: $server_response", "", $line, __FILE__);
  		  return false;
  	}
  	return true;
  }
  ...
  function smtpmail($mail_to, $subject, $message, $headers = '') {
  	...
  	fputs($socket, "MAIL FROM: <" . $this->email_from . ">\r\n");
  	if(!$this->server_parse($socket, "250", __LINE__)) return false;
