<?php
class command_insert extends acommand_internal implements icommand_internal {
	...
	public function execute() {
		...
		$cmd->set_type(command_process_row::type_insert);
        
		$ok = $cmd->execute();
        
        if ( $ok ) {
            $this->table->only_one_insert_sets();
        }
