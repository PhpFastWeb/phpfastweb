...
<?php
    if (!isset($_POST) || count($_POST)==0) {
        ...
        echo 'Ocurrió un error al recibir el informe de error.<br />Quizás no cargó esta página desde el formulario de envío de error.<br /><br />Adicionalmente, nuestros técnicos han sido notificados de ésta circunstancia.';    
        echo '</div></body></html>';
        die;
    } 
    
    echo '<h2>Informe enviado correctamente.</h2>';
    ...
    if ($result) {
        echo 'Se ha enviado una notificación a nuestros técnicos para que revisen el error.<br />';
    } else {
